...
config = {
	...
	"dbName": "E-Commerce_Ref",
	"collections": [
		{"name": "addresses", "folder": "dumpAddresses", "shardKey": "_id", "strategy": "hashed"},
		{"name": "categories", "folder": "dumpCategories", "shardKey": "_id", "strategy": "hashed"},
		{"name": "orderItems", "folder": "dumpOrderItems", "shardKey": "orderId", "strategy": "hashed"},
		{"name": "orders", "folder": "dumpOrders", "shardKey": "userId", "strategy": "hashed"},
		{"name": "products", "folder": "dumpProducts", "shardKey": "_id", "strategy": "hashed"},
		{"name": "reviews", "folder": "dumpReviews", "shardKey": "productId", "strategy": "hashed"},
		{"name": "shoppingCartItems", "folder": "dumpShoppingCartItems", "shardKey": "userId", "strategy": "hashed"},
...
def importJsonFolder(client, dbName, collName, folderPath, batchSize=1000):
	...
	if not folder.exists():
		...
		return
	# Prefer mongorestore from BSON dumps when available
