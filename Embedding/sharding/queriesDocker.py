...
def runWithoutIndex(db, collectionName, queryFilter, projection=None, sort=None, limit=None):
    ...
    try:
        ...
        try:
            ...
            # fallback: retry without hint (useful if hint not allowed for this query) - ex text search
            try:
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            if explainRecords:
                with open('./Embedding/sharding/explainQueries.json', 'w', encoding='utf-8') as f:
